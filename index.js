...
const config = {
    A187: '👾mdbot-wa👾', // TOBAT SU ASU
    instagram: 'https://instagram.com', // INFO JANGAN DI UBAH
    nomer: 'wa.me/13132900007', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtube.com', // KINTIL
    whatsapp: 'https://chat.whatsapp.com/JShaSrtjtWXIe4BM6tU8hI', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["13132900007@s.whatsapp.net"] // ganti nomer lu
